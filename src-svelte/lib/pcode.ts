...
export const HELP_DB: Record<string, HelpEntry> = {
    ...
    stackframes: {
        ...
        syntax:      'StackFrames [flat=<path>]',
        arguments: [
            { name: 'flat', type: 'path', required: false, description: 'Flat master divided into every frame before registration. Must match the light frames in dimensions, channel count, colour space, and Bayer pattern.' },
        ],
    ...
    rejectframe: {
        ...
        syntax:      'RejectFrame [index=<integer>] [append=<string>]',
        arguments: [
        ...
        example: 'RejectFrame\nRejectFrame index=42\nRejectFrame append=cloudy',
    },
