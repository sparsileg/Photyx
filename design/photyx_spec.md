...
| **Phase 8**  | Substantially complete — moment-based FWHM; 8×8 background gradient grid; 5-pixel minimum star filter; WriteFITS U16 sign conversion fix; histogram canvas width fix; ContourHeatmap plugin (spatial FWHM heatmap, adaptive grid 5×5–15×15, viridis/plasma/coolwarm palettes, XISF output, `$NEW_FILE` convention); display pipeline refactor (explicit AutoStretch, raw display, blink-only cache); image_reader.rs format-agnostic reader; LoadFile pcode command, File > Load Single Image, DispatchResponse.data, histogram hover readout, Full keyword management UI, Auto-STF toolbar toggle, arithmetic, parentheses, basic operators in pcode, major bug fixes and enhancements for macro creation and execution, |
...
| **Deferred** | ⏸PNG/JPEG readers and writers, debayering,  async dispatch                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
