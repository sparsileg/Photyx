...
10. Pulse the "Cache is being built" notification via `notifications.running()`
11. ~~Bg Std Dev and Bg Gradient removal from the analysis engine~~
12. SNR estimator revision
